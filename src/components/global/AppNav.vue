    ...
    <v-app-bar color="#02218F" height="fit-content" absolute>
      <v-container fluid>
        <v-row>
          ...
          <v-col cols="5">
            <div class="relative w-[90%]">
              <input
                ...
                class="w-[100%] py-3 px-5 bg-white rounded-[30px] outline-none"
              />
              <svg
                data-icon="search"
                viewBox="0 0 512 512"
                width="100%"
                height="100%"
                class="absolute right-[10px] -translate-y-1/2 top-[50%] w-[20px]"
              >
                <path
          ...
          <v-col cols="4" class="ps-8">
            <div class="parent flex justify-between items-center">
              ...
              <div class="wishlist flex flex-col items-center text-orange-300">
                <svg
                  viewBox="0 0 512 512"
                  class="icon icon-wishlist w-[28px] fill-orange-300"
                >
                  <g>
                    <g>
                      <path
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <div class="sign-in flex flex-col items-center text-orange-300">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  class="icon icon-account w-[28px] fill-orange-300"
              ...
              <div
                class="cart flex flex-col items-center text-orange-300 cursor-pointer"
                @click="openCart"
              >
                <v-badge
                  location="right top"
          ...
          <v-col cols="5" class="flex justify-end gap-[35px]">
            <div class="help flex items-center gap-1">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                class="svg-inline--fa fa-user-headset fa-w-14 fa-3x w-[20px] text-[#256eF1]"
              >
                <path
                  fill="currentColor"
            ...
            <div
              class="lang flex items-center gap-1 cursor-pointer"
              id="language-btn"
            >
              ...
              <v-menu activator="#language-btn">
                <v-list v-model:selected="selectedLang">
                  <v-list-item v-for="lang in langs" :key="lang" :value="lang">
                    <v-list-item-title class="flex items-center gap-[10px]">
                      <span v-html="lang.icon"></span> {{ lang.language }} /
                      {{ lang.currency }}
                    </v-list-item-title>
                  </v-list-item>
                </v-list>
