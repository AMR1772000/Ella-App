  ...
  <div class="features">
    <v-container>
      <v-row>
        <v-col>
          <div class="parent flex items-center justify-center">
            <svg
              ...
              viewBox="0 0 640 512"
              class="svg-inline--fa fa-shipping-fast fa-w-20 fa-3x mr-5 w-[30px]"
            >
              <path
                fill="currentColor"
        ...
        <v-col>
          <div class="parent second flex items-center justify-center relative">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fas"
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
              class="svg-inline--fa fa-award fa-w-12 fa-3x mr-5 w-[25px]"
            >
              <path
                fill="currentColor"
        ...
        <v-col>
          <div class="parent flex items-center justify-center">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              class="svg-inline--fa fa-trophy-alt fa-w-18 fa-3x mr-5 w-[30px]"
            >
              <path
                fill="currentColor"
