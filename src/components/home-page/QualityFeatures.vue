<template>
  <div class="quality-features bg-grey-lighten-3 py-13">
    <v-container fluid>
      <v-row>
        <v-col v-for="card in cards" :key="card.title" class="px-2">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              height="400"
              class="text-center flex items-center justify-center cursor-pointer"
              :color="isHovering ? 'deep-purple-lighten-3' : 'white'"
            ...
            >
              <div class="parent">
                ...
                >
                <v-card-text class="px-8">{{ card.desc }}</v-card-text>
              </div>
            </v-card>
          </v-hover>
        </v-col>
...
const cards = ref([
  ...
  {
    title: "FAST SHIPPING",
    desc: "Fast and convenient door to door shipping",
  ...
  },
  {
    ...
    desc: "More than 10 diffrent secure payment methods",
